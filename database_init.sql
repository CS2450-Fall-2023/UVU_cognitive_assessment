...
INSERT INTO questions VALUES
    ...
    (2, 1, 'Behind-The-Scenes', 'People of this style focus on understanding and working with the process to create ' ||
    ...
    (3, 1, 'In-Charge', 'People of this style are focussed on results, often taking action quickly. They often have ' ||
    ...
    (4, 1, 'Get-Things-Going', 'They thrive in facilitator or catalyst roles and aim to inspire others to move to ' ||
    ...
    (5, 2, 'Foreseer Developer', 'Personal growth. Sustain the vision. Honoring the gifts of others. Taking a ' ||
    ...
    (6, 2, 'Planner Inspector', 'Drawing up plans and being prepared. Take responsibility. Getting work done first. ' ||
    ...
    (7, 2, 'Conceptual Director', 'Maximizing achievements. Drive for self-mastery. Build a vision. Very long-range ' ||
    ...
    (8, 2, 'Analyzer Operator', 'Actively solving problems. Observing how things work. Talent for using tools for ' ||
    ...
    (9, 3, 'Harmonizer Clarifier', 'Going with the flow. Knowing what is behind what is said. Uncovering mysteries. ' ||
    ...
    (10, 3, 'Protector Supporter', 'Noticing what''s needed and what''s valuable. Talent for careful and supportive ' ||
    ...
    (11, 3, 'Designer Theorizer', 'Becoming an expert. Seeing new patterns and elegant connections. Talent for ' ||
                                  ...
                                  'world.'),
    (12, 3, 'Composer Producer', 'Taking advantage of opportunities. Stick with what''s important. Talent for ' ||
    ...
    (13, 4, 'Envisioner Mentor', 'Communicate and share values. Succeeding at relationships. Realizing dreams-their ' ||
    ...
    (14, 4, 'Implementor Supervisor', 'Talent for bringing order to chaotic situations. Educating themselves. ' ||
    ...
    (15, 4, 'Strategist Mobilizer', 'Being a leader. Maximize talents. Marshal resources toward progress. Intuitive ' ||
    ...
    (16, 4, 'Promoter Executer', 'Taking charge of situations. Tactical prioritizing. Talent for negotiating. Want ' ||
    ...
    (17, 5, 'Discoverer Advocate', 'Inspiring and facilitating others. Exploring perceptions. Talent for seeing ' ||
    ...
    (18, 5, 'Facilitator Caretaker', 'Accepting and helping others. Managing people. Hearing people out. Voicing ' ||
    ...
    (19, 5, 'Explorer Inventor', 'Being inventive. Talented at building prototypes and getting projects launched. ' ||
    ...
    (20, 5, 'Motivator Presenter', 'Stimulating action. Have a sense of style. Talent for presenting things in a ' ||
